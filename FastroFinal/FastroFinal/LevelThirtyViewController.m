...
@interface LevelThirtyViewController ()
...
@implementation LevelThirtyViewController
...
- (void)scoreChange {
    ...
    if (score == 40) {
        ...
        if ([LevelController sharedInstance].arrayOfCompletedLevels.count >= 31) {
...
- (void)playAudio {
    ...
    NSURL *url = [[NSBundle mainBundle] URLForResource:@"Electro Cabello" withExtension:@"mp3"];

//
//  LevelTwentyFiveViewController.m
//  FastroFinal
//
...
@interface LevelTwentyFiveViewController ()
...
@implementation LevelTwentyFiveViewController
...
- (IBAction)startGame:(id)sender {
    ...
    [self animateView:self.obstacleView duration:1.5];
...
- (void)fastroMoving {
    ...
    if (CGRectIntersectsRect(self.fastronaut.frame, self.bottomView.frame)) {
...
- (void)scoreChange {
    ...
    if (score == 40) {
        ...
        if ([LevelController sharedInstance].arrayOfCompletedLevels.count >= 25) {
...
- (void)playAudio {
    ...
    NSURL *url = [[NSBundle mainBundle] URLForResource:@"Severe Tire Damage" withExtension:@"mp3"];
